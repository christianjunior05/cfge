            ...
            <div class=" col-sm-12 footer-content-box">
                ...
                <div class="col-sm-3">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="#"><span><i class="fa fa-long-arrow-right footer-icon"></i></span>CFGE Côte d'Ivoire</a></li>
                ...
                <div class="col-sm-3">
                    <h3>Newsletter</h3>
                    <p>Abonnez-vous à notre newsletter pour être toujours à jour des dernières nouveautés,
                        événements à venir, ressources utiles et bien plus encore.</p>
                    ...
                    <form action="" method="post">
                        <div class="form-group">
                            ...
                            <div class="submit-btn">
                                <div class="submit-btn">
                                    <button type="submit" class="text-center" name="nl">S'INSCRIRE</button>
                                </div>
                            </div>
                        </div>
                    </form>
