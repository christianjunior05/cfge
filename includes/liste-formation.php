...
<option value="Certif - Audit et Contôle légale des Comptes"
    <?php if (isset($_POST["form-sou"]) and $_POST["form-sou"] === "Certif - Audit et Contôle légale des Comptes") echo "selected"; ?>>
    Certification - Audit et Contôle légale des Comptes</option>
...
<option value="Certif - Comptabilité Internationale"
    <?php if (isset($_POST["form-sou"]) and $_POST["form-sou"] === "Certif - Comptabilité Internationale") echo "selected"; ?>>
    Certification - Comptabilité Internationale</option>