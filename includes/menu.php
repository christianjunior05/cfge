...
<li class="<?php echo ($current_page === 'about.php' || $current_page === 'mission-valeur.php' || $current_page === 'team.php') ? 'active' : ''; ?>"><a data-scroll="" href="">Le CIFEC Benin</a>
...
<li class="<?php echo ($current_page === 'lstcf.php' || $current_page === 'mcca-escae.php' || $current_page === 'dcg.php' || $current_page === 'dscg.php' || $current_page === 'lcca.php' || $current_page === 'gestion.php' || $current_page === 'mcca-intec.php' || $current_page === 'audit.php' || $current_page === 'auditsy.php' || $current_page === 'comptabilite.php' || $current_page === 'lcca.php') ? 'active' : ''; ?>"><a data-scroll="" href="">Nos Programmes</a>
    <ul class="dropdown list-unstyled">
        ...
        <!-- <li class="dropdown-list-box-02"><a href="#">Programme national<i class="fa fa-angle-right menu-icon"></i></a>
            <ul class="dropdown-list_2 list-unstyled">
                <li><a href="">Licence Nationale</a></li>
                <li><a href="dscg.php">La Licence en Finance comptabilité et Audit (FCA) du CIFEC</a></li>
            </ul>
        </li> -->
...
<li class="<?php echo ($current_page === 'admission-post-bac.php' or $current_page === 'admission-post-bts.php' or $current_page === 'preinscription.php' or $current_page === 'faq.php') ? 'active' : ''; ?>"><a data-scroll href="">Admissions</a>
    <!-- dropdwon start -->
    <ul class="dropdown list-unstyled">
...
<!-- <li class=""><a data-scroll href="">Entreprise</a> -->
