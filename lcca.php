			...
			<div class="col-sm-8 sidebar-left">
				<div class="single-curses-contert">
                    ...
                    <div class="description-content">
						...
						<hr>
                        <p style="font-size:17px">Cette troisième année de licence permet d'acquérir une formation dans les
					...
					<div class="description-content">
						...
						L2 économie-gestion,DUT GEA, BTS Comptabilité.La sélection des candidats est réalisée sur dossier (avec CV et lettre de motivation) et entretien.</p>
						<h1>Conditions d'admision</h1>
						<hr>
						<p style="font-size:17px">Sont reçus à la licence CCA les candidats ayant validé les 2 semestres soit une
                    ...
                    <div class="description-content" style="font-size:17px">
						...
						<hr>
                        <p style="font-size:17px">La licence CCA permet une insertion sur le marché du travail pour occuper un poste :</p>
                        <ul>
