    ...
    var _ISM = _R.is_mobile()
            ...
            a.find(".tp-caption, .rs-background-video-layer").each(function(a) {
                ...
                c.hasClass("tp-caption")) {
                    var m = c.hasClass("slidelink") ? "width:100% !important;height:100% !important;" : ""
                      ...
                      , r = "";
                    "row" === o ? (c.addClass("rev_row").removeClass("tp-resizeme"),
                    r = "rev_row_wrap") : "column" === o ? (r = "rev_column",
                    ...
                    var s = ""
                      , t = "";
                    "row" !== o && "group" !== o && "column" !== o ? (s = "display:" + c.css("display") + ";",
                    c.closest(".rev_column").length > 0 ? (c.addClass("rev_layer_in_column"),
                    i = !1) : c.closest(".rev_group").length > 0 && (c.addClass("rev_layer_in_group"),
                    i = !1)) : "column" === o && (i = !1),
                    n.wrapper_class !== undefined && (r = r + " " + n.wrapper_class),
                    n.wrapper_id !== undefined && (t = 'id="' + n.wrapper_id + '"'),
                    c.wrap('<div class="tp-parallax-wrap ' + r + '" style="' + m + "position:" + q + ";" + s + ';visibility:hidden"><div class="tp-loop-wrap" style="' + m + "position:" + q + ";" + s + ';"><div class="tp-mask-wrap" style="' + m + "position:" + q + ";" + s + ';" ></div></div></div>'),
                    ...
                    "column" === o && (c.append('<div class="rev_column_bg rev_column_bg_man_sized" style="display:none"></div>'),
                ...
                _ISM && (1 != e && "true" != e || (d.autoplayonlyfirsttime = !1,
                e = !1),
      ...
      , prepareSlides = function(a, b) {
        ...
        b.allli.find(">img").each(function(a) {
            ...
            c.parent().append('<div class="tp-bgimg defaultimg ' + f + '" style="background-color:' + c.css("backgroundColor") + ";background-repeat:" + g.bgrepeat + ";background-image:url(" + h + ");background-size:" + g.bgfit + ";background-position:" + g.bgposition + ';width:100%;height:100%;"></div>'),
            ...
            c.data(g),
            c.attr("src", h),
            "standard" !== b.sliderType && "undefined" !== b.sliderType || c.css({
                opacity: 0
            })
        }),
            ...
            if (c.data("loaded") === undefined && f !== undefined && f.progress && f.progress.match(/loaded/g)) {
                ...
                "img" == f.type)
                    if (c.hasClass("defaultimg"))
                        _R.isIE(8) ? defimg.attr("src", f.src) : c.css({
