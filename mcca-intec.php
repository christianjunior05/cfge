                ...
                <div class="col-sm-8 sidebar-left">
                    <div class="single-curses-contert">
                        ...
                        <div class="description-content">
                            ...
                            <p style="font-size:17px"> Reconnu par l’enseignement supérieur français et le CAMES, le
                                MCCA est un
                            ...
                            <p style="font-size:17px">Le MCCA a l’ambition d’offrir à des professionnels disposant
                                d&#39;une première
                                ...
                                gestion, de l’audit interne, de l&#39;audit externe et du reporting et contrôle
                                financier des
                                groupes.</p>
                        </div>
                        <div class="description-content">
                        ...
                        <div class="description-content">
                            ...
                            <p style="font-size:17px">Reconnu par l’enseignement supérieur français et le CAMES, le MCCA
                                est un
                                diplôme de grade BAC + 5 délivré par l’ESCAE de Niamey. Il prépare au Diplôme
                                Supérieur de Comptabilité et de Gestion (DSCG) qui offre la possibilité à ses
                                détenteurs de réaliser leur stage d’expertise-comptable.</p>
                            <p style="font-size:17px">Le MCCA a l’ambition d’offrir à des professionnels disposant d'une
                                première
                                expérience, un complément de formation de haut niveau à finalité professionnelle et
                                de recherche, centré sur les métiers et les techniques du conseil, du contrôle de
                                gestion, de l’audit interne, de l&#39;audit externe et du reporting et contrôle
                        ...
                        <div class="description-content">
                            ...
                            <p style="font-size:17px">Dépôt des dossiers pour accès en Licence CCA 3ème année via le
                                lien suivant :
                                xxxxxx.</p>
                        </div>
                        <div class="description-content">
                            ...
                            <ul>
                                <li style="font-size:17px">Les candidatures pour la LSTCF sont ouvertes du 15/04/2023 au
                                    15/09/2023</li>
                                <li style="font-size:17px">Les cours en présentiel, avec webconférences et support de
                                    cours papier et
                                    numériques, inscriptions ouvertes à compter du 5 juillet.</li>
                                <li style="font-size:17px">Les cours du soir avec webconférences et support de cours
                                    papier et
                                    numériques, inscriptions ouvertes à compter du 5 juillet.</li>
                            </ul>
                        ...
                        <div class="description-content">
                            ...
                            <hr>
                            <p style="font-size:17px">Sont autorisés à suivre cette préparation les candidats ayant
                                l&#39;un des diplômes
                                suivants :</p>
                            <ol>
                                <li style="font-size:17px">La LSTCF</li>
                                <li style="font-size:17px">une licence générale reconnue par le CAMES dans le domaine de
                                    la
                            ...
                            <ul>
                                ...
                                <li style="font-size:17px">Sont reçus au master CCA les candidats ayant validé les 4
                                    semestres
                                    avec une moyenne au moins égale à 10/20 à chaque semestre (sans note inférieure à
                                    6/20 aux UE).</li>
                                <li style="font-size:17px">Sont reçus à la licence CCA les candidats ayant validé les 2
                                    semestres soit une
                        ...
                        <div class="description-content">
                            <ul>
                                <li style="font-size:17px">Collaborateur en cabinet d’expertise comptable ou d’audit
                                    visant l’expertise
                                    comptable ;</li>
                                <li style="font-size:17px">Contrôleur de gestion, directeur comptable, DAF, auditeur
                                    interne en
                            ...
                            <hr>
                            <p style="font-size:17px">La finalisation du DSCG permet de rentrer en stage d’expertise
                                comptable en
                            ...
                            <hr>
                            <p style="font-size:17px">Le programme de formation du master CCA de l’Intec est conforme au
                                programme
                            ...
                            <ul>
                                ...
                                <li style="font-size:17px">S1 : UE 533 - S2 : UE 543 : Management et contrôle de gestion
                                </li>
                                <li style="font-size:17px">S1 : UE 535 - S2 : UE 545 : Management des systèmes
                                    d'information</li>
                                <li style="font-size:17px">S1 : UE 536 - S2 : UE 546 : Anglais des affaires</li>
                            </ul>
                            <p style="font-size:17px">Master 2</p>
                            <ul>
                                <li style="font-size:17px">S1 : UE 531 - S2 : UE 541 : Gestion juridique, fiscale et
                                    sociale</li>
                                <li style="font-size:17px">S1 : UE 534 - S2 : UE 544 : Comptabilité et audit</li>
                                <li style="font-size:17px">S1 : UE 537 - S2 : UE 547 : Préparation au mémoire S1 et
                                    Mémoire S2</li>
                            </ul>
                        </div>
                        <br>
                        <a class="text-light"
                            href="https://www.demarches-simplifiees.fr/commencer/cnam-centre-d-abidjan-cfge-dossier-de-candidature-2522425"
